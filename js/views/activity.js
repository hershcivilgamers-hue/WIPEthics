...
const TONE = {
  ...
  SET_ISD_MEMBERSHIP: 'warn', SET_ISD_BADGE: 'muted',
  OPEN_INVESTIGATION: 'warn', LOG_INVESTIGATION: 'info', ADVANCE_INVESTIGATION: 'warn',
  EDIT_INVESTIGATION: 'info', REMOVE_INVESTIGATION: 'bad', RESTORE_INVESTIGATION: 'ok',
  OPEN_INDUCTION: 'ok', EDIT_INDUCTION: 'info', DECIDE_INDUCTION: 'warn', REMOVE_INDUCTION: 'bad', RESTORE_INDUCTION: 'ok',
